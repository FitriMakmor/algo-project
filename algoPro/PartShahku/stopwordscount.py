infile = "TotalThai.txt"
outfile = "Cleaned_TotalThai.txt"

word_count = 0

file_name = "TotalThai.txt"
...
print("For ", infile)
print("numbeer of words before clean: ", word_count)
...
file_name2 = "Cleaned_TotalThai.txt"

with open(file_name2, 'r') as file:
    for line in file:
        word_count2 += len(line.split())



print("number of words after clean: ", word_count2)
print("number of stop words: ",word_count - word_count2)
